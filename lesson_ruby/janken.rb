...
class Attimuite_game
    ...
    def attimuite_hoi_myself
        ...
        if attimuite_my_hand == attimuite_computer_hand
...
if next_game == attimuite_hoi_myself
    battle1.attimuite_hoi_myself
else next_game == attimuite_hoi_computer
    battle1.attimuite_hoi_computer
end
